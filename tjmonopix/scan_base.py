...
class ScanBase(object):
    ...
    def __init__(self, dut=None, filename=None, send_addr="tcp://127.0.0.1:5500"):
        ...
        if dut is None:
            ...
            self.dut['CONF_SR']['EN_PMOS'][27:0] = True
            print self.dut['CONF_SR']['EN_PMOS']
            ...
            #self.dut['CONF_SR']['MASKH'][112:0]=False
            #print len(self.dut['CONF_SR']['MASKH']),self.dut['CONF_SR']['MASKH'].to01()
            #import sys
            #sys.exit()
