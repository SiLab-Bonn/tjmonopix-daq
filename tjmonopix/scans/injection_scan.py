...
class InjectionScan(scan_base.ScanBase):
    ...
    def scan(self,**kwargs):
        ...
        for g in glist:
          ...
          for mask_i in range(mask_n):
            ...
            self.dut.set_preamp_en(mask_pix) ### TODO 
    ...
    def analyze(self):
        ...
        import tjmonopix_daq.analysis.interpreter_idx as interpreter_idx
        interpreter_idx.interpret_idx_h5(fraw,fhit,debug=0x8+0x3)
        self.logger.info('interpreted %s'%(fhit))
        import tjmonopix_daq.analysis.event_builder_inj as event_builder_inj
        event_builder_inj.build_inj_h5(fhit,fraw,fev,n=10000000)
        self.logger.info('timestamp assigned %s'%(fev))
        
        ##analyze
        import tjmonopix_daq.analysis.analyze_hits as analyze_hits
    ...
    def plot(self):
        ...
        import tjmonopix_daq.analysis.plotting_base as plotting_base
...
if __name__ == "__main__":
    from tjmonopix_daq import tjmonopix
    ...
    scan = InjectionScan(m,online_monitor_addr="tcp://127.0.0.1:6500")
