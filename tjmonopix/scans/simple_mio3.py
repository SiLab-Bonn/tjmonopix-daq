...
#     mask = '/media/silab/Maxtor/tjmonopix-data/development/noise_tuning/test_noise_tuning_W04R08_PMOS_-6_-6.yaml'
    ...
    scan = SimpleScan(dut=dut, filename=args.data, send_addr=scan_config["online_monitor"])
    dut.save_config(scan.output_filename + '.yaml')
    scan.start(scan_timeout=args.scan_timeout, with_tdc=False, with_timestamp=False, with_tlu=False, with_tj=True)
