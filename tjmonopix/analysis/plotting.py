...
class plotting():
	...
	t1 = ax1.text(0.02, 0.85, textright, transform=ax1.transAxes, fontsize=16, bbox=dict(facecolor='wheat', alpha=0.4))
	...
	t1 = ax2.text(1.22, 0.85, textright, transform=ax1.transAxes, fontsize=16, bbox=dict(facecolor='wheat', alpha=0.4))
	for item in ([ax2.title, ax2.xaxis.label, ax2.yaxis.label] +
